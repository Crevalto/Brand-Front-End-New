                ...
                <div class="card-body">
                  ...
                  <Button
                    data-param={JSON.stringify({
                      ...
                      padd: product.stockAddress,
                      pqty: product.quantity,
                      pprice: product.salePrice,
                      psize: product.size,
          ...
          <Modal.Body>
            <div class="row model">
              <div class="col-md-6 full-all-img">
                <h5>
                  <span>Rs</span> {this.state.modalproduct.pprice}
                </h5>
                <img
                  src={this.state.modalproduct.img}
                  class="card-img-top"
                  alt="..."
                />
              </div>
              <div class="col-md-6 product-full-desc">
                <div class="desc-content">
                  ...
                  <hr />
                  <h5>
                    <span>Available qty : </span> {this.state.modalproduct.pqty}
                  </h5>
                  <div class="sizes">
                    <span>Xs</span>
                    <span>Sm</span>
                  ...
                  <Button
                    variant="secondary"
                    data-param={JSON.stringify({
                      id: this.state.modalproduct.pid,
                      qty: this.state.modalproduct.pqty,
                    })}
