      ...
      <Jumbotron className="jum">
        <Row>
          ...
          <Col md={5}>
            <div class="round">
              <h2 className="pquote">
                Let's show the love and kind towards the fashion industry
              </h2>
            </div>
          </Col>
        </Row>
        ...
        <div class="col-md-6">
          <div class="card-selection">
            ...
            <p>
              ...
              elementum, orci sed consectetur rhoncus, ipsum lectus convallis
              lacus, eu mollis ante ante sed dui. Maecenas consectetur lectus
              non mauris suscipit, ac porta risus scelerisque. Praesent eu
              rhoncus massa. Vivamus eu dolor sit amet turpis malesuada
              eleifend.
            </p>
          </div>
        </div>
